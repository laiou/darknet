...
extern "C" void forward_maxpool_layer_gpu(maxpool_layer layer, network net)
{
    ...
    //具体的实现maxpool的核函数
    //forward_maxpool_layer_kernel的具体实现参考src/maxpool_layer_kernels.cu
...
//gpu版本的maxpool层的反向传播的实现
extern "C" void backward_maxpool_layer_gpu(maxpool_layer layer, network net)
{
    size_t n = layer.h*layer.w*layer.c*layer.batch;
    //具体的核函数backward_maxpool_layer_kernel实现参考src/maxpool_layer_kernels.cu
